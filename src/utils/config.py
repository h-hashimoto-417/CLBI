...
BUG_TYPE_LIST = [
    'CHANGE_IDENTIFIER', 'CHANGE_MODIFIER', 'DIFFERENT_METHOD_SAME_ARGS', 'CHANGE_NUMERAL',
    'OVERLOAD_METHOD_MORE_ARGS', 'CHANGE_OPERATOR', 'LESS_SPECIFIC_IF', 'CHANGE_CALLER_IN_FUNCTION_CALL',
    'OVERLOAD_METHOD_DELETED_ARGS', 'MORE_SPECIFIC_IF', 'CHANGE_UNARY_OPERATOR', 'SWAP_BOOLEAN_LITERAL',
